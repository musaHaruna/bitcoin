...
void CClientUIInterface::NotifyBlockTip(SynchronizationState s, interfaces::BlockTip block, double verification_progress) { return g_ui_signals.NotifyBlockTip(s, block, verification_progress); }
