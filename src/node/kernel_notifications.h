...
public:
    ...
    [[nodiscard]] kernel::InterruptResult blockTip(SynchronizationState state, kernel::BlockTip tip, double verification_progress) override EXCLUSIVE_LOCKS_REQUIRED(!m_tip_block_mutex);
